 ...
 * @deprecated use print_contract_details instead
 */
async function print_erc20_acl_details(a0, abi, address, a1) {
	...
	const r1 = toBN(a1? await web3_contract.methods.getRole(a1).call(): 0);
	const allowance = toBN(a1? await web3_contract.methods.allowance(a0, a1).call(): 0)
	...
	console.table([
		...
		{"key": "A1 Allowance", "value": allowance.toString(10)}, // 10
	]);
	return {features, r0, r1, allowance};
}
