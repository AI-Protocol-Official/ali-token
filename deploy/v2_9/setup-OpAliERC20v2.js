// run: npx hardhat deploy --network opBnb_testnet --tags setup-OpAliERC20v2-opBnb
...
module.exports.tags = ["setup-OpAliERC20v2-opBnb", "v2_9", "setup", "L3", "l3"];
module.exports.dependencies = ["OpAliERC20v2-opBnb"];
